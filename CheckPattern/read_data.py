    ...
    if line[2:11] == "League ID":
        ...
        for league_id, league in new_season.items():
            ...
            for week, matches in league.items():
                ...
                count = 1
                for teams, outcome in matches.items():
                    if outcome["correct_score"][0] == "2-2":
                        # if (
                        #     outcome["correct_score"][0] == "4-0"
                        #     or outcome["correct_score"][0] == "0-4"
                        # ):
                        # if (
                        #     outcome["correct_score"][0] == "4-1"
                        #     or outcome["correct_score"][0] == "1-4"
                        # ):
                        # if (
                        #     outcome["ht/ft"][0] == "1/2"
                        #     or outcome["correct_score"][0] == "3-3"
                        # ):
                        # if (
                        #     outcome["ht/ft"][0] == "2/1"
                        #     or outcome["correct_score"][0] == "3-3"
